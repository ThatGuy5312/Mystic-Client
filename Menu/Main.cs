...
namespace MysticClient.Menu
{
    ...
    public class Main : MonoBehaviour
    {
            ...
            try
            {
                ...
                if (menu == null)
                {
                    if (toOpen || keyboardOpen)
                    {
                        ...
                        if (menu.GetComponent<Rigidbody>()) Destroy(menu.GetComponent<Rigidbody>());
                    }
                }
                else
                {
                ...
                try
                {
                    ...
                    {
                        Physics.Raycast(mainCamera.ScreenPointToRay(UserInput.mousePosition), out RaycastHit hit);
            ...
            else
            {
                ...
                if (TPC != null)
                {
                    ...
                    if (reference != null)
                        ...
                        {
                            if (Physics.Raycast(TPC.ScreenPointToRay(Mouse.current.position.ReadValue()), out RaycastHit hit, 100))
        ...
        */
        ...
        "Fixed Spammer Mods, Added Glider Halo, Added Change Gun Type, Added Old Gun Direction, Fixed Notifications";
