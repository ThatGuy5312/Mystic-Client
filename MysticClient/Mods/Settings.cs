...
namespace MysticClient.Mods
{
    public class Settings
    {
        ...
        public static PrimitiveType[] shapes = { PrimitiveType.Cube, PrimitiveType.Sphere, PrimitiveType.Capsule, PrimitiveType.Cylinder, PrimitiveType.Plane, PrimitiveType.Quad };
        ...
        private static void SidePageButtons()
        {
            ...
            pageButtonSize = new Vector3(0.045f, 0.25f, 1f);
            pagePoss[0] = new Vector3(0.56f, 1f, -.1f); // -.571f
            pagePoss[1] = new Vector3(0.56f, -1f, -.1f);
        }
